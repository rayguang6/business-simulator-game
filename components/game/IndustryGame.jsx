...
export default function IndustryGame({ industryData, initialCards }) {
  ...
  // The rest of your game logic remains largely the same as in your original IndustryPage component
  // Process month end, makeDecision, closeMonthSummary, restartGame, getProfit functions
...
// components/game/IndustryGame.jsx (continuing)
) : showMonthSummary ? (
    <motion.div
      key="month-summary"
      initial={{ opacity: 0, scale: 0.9 }}
